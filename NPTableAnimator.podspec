...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of NPTableAnimator.'
...
This pod was developed for building table animations
  ...
  s.homepage         = 'https://github.com/Nikita Patskov/NPTableAnimator'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Nikita Patskov' => 'patskovn@yahoo.com' }
  s.source           = { :git => 'https://github.com/Nikita Patskov/NPTableAnimator.git', :tag => s.version.to_s }
